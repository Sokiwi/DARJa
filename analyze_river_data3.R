...
x <- read.table("rivers_l_all2.txt", sep="\t", header=TRUE)

# with increased distance between two points the absence of a river
# becomes increasingly rare; absence of one of the binary values 
# will upset the gam 
# investigate when it happens
x0 <- x[x$number_rivers==0,]
max(x0$geodist)
plot(density(x0$geodist))
...
#(Intercept) 0.529009   0.002767 191.178  < 2e-16 ***
#  rivers1     0.015872   0.002767   5.735 9.72e-09 ***
#  ---
#  Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# Approximate significance of smooth terms:
#  edf Ref.df      F p-value    
# s(geodist):rivers0 8.270  8.641  24715  <2e-16 ***
#  s(geodist):rivers1 8.966  8.999 406765  <2e-16 ***
#  ---
#  Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# R-sq.(adj) =  0.437   Deviance explained = 43.7%
# fREML = -7.8289e+06  Scale est. = 0.005709  n = 6726444
